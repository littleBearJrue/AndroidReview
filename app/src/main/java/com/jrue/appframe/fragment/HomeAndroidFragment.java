 ...
 */
public class HomeAndroidFragment extends BaseFragment{
    public static final String TAG = "HomeAndroidFragment";
    @Override
    ...
    public View mzOnCreateView(LayoutInflater inflater, ViewGroup container) {
        return inflater.inflate(R.layout.about_android_layout, container, false);
    }
